...
if OPT.grayscale then
    IMG_DIMENSIONS = {1, OPT.fineSize, OPT.fineSize * 2}
    COND_DIM = {1, OPT.fineSize, OPT.fineSize * 2}
else
    IMG_DIMENSIONS = {3, OPT.fineSize, OPT.fineSize * 2}
    COND_DIM = {3, OPT.fineSize, OPT.fineSize * 2}
end
-- size in values/pixels per input image (channels*height*width)
INPUT_SZ = IMG_DIMENSIONS[1] * IMG_DIMENSIONS[2] * IMG_DIMENSIONS[3]
NOISE_DIM = {1, OPT.fineSize, OPT.fineSize * 2}
...
DATASET.setCoarseHeight(OPT.coarseSize)
DATASET.setCoarseWidth(OPT.coarseSize * 2)
DATASET.setFineHeight(OPT.fineSize)
DATASET.setFineWidth(OPT.fineSize * 2)
